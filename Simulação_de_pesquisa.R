...
# e desvio padrão escolhidos pelo autor em um período de 15 anos usando o coeficiente
# de correlação.



# Gerando dados fictícios para o PIB e o índice de desemprego
...
#erados de uma distribuição normal 
